...
from .models import AdvUser, SubRubric, Bb, Comment, AuthorBook
...
def index(request):
    ...
    author_book = AuthorBook.objects.get()
    context = {'bbs': bbs, 'author_book': author_book}
...
def detail(request, rubric_pk, pk):
    ...
    context = {'bb': bb, 'author_book': author_book, 'ais': ais, 'comments': comments, 'form': form}
