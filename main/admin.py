...
from .models import AdvUser, Bb, AdditionalImage, Comment, AuthorBook
...
class BbAdmin(admin.ModelAdmin):
    list_display = ('title', 'rubric', 'author', 'created_at', 'release_date')
    fields = (('title','slug'), ('rubric', 'lang_category', 'release_date'), ('author', 'author_book'), 'content', 'image', 'book_file', 'is_active')
